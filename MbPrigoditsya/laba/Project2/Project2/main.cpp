...
GLfloat miror_cone[] = { 1, 0.0, 0.0, 1.0 };
GLfloat dif_cone[] = { 0.2, 0.2, 0.2, 1.0 };
GLfloat AMB_cone[] = { 0.0, 0.04, 0.2, 1.0 };
GLfloat EMIS_cone[] = { 0.7, 0.0, 0.0, 0.2 };


GLfloat pot_pos[3] = { 0, 0 , 0 };
GLfloat miror_pot[] = { 0.3, 1.0, 0.4, 1.0 };
GLfloat dif_pot[] = { 0.0, 1.0, 0.88, 1 };
GLfloat AMB_pot[] = { 0.0, 0.0, 0.0, 1.0 };
GLfloat EMIS_pot[] = { 0.0, 0.0, 0.0, 1.0 };

GLfloat miror_ico[] = { 0.1, 0.2, 0.9, 1.0 };
GLfloat dif_ico[] = { 0.2, 0.9, 0.2, 0.8 };
